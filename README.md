...
3. Each contributor will have to clone the new forked repository and develop one piece of the website you have chosen, each project is divided in pieces inside its **templates/** directory.
